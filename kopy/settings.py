"""
Django settings for kopy project.
...
db_config = ConfigObj(os.environ['DB_CONFIG_PATH'])
...
WSGI_APPLICATION = 'kopy.wsgi.application'


# Database
# https://docs.djangoproject.com/en/1.11/ref/settings/#databases
DATABASES = {
    'default': db_config['KOPERNIKUS'],
    'sqlite': {
